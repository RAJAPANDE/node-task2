...
const userSchema = new mongoose.Schema({
    ...
    mobileNo: { type: String, required: [true, 'Mobile number is required'], match: [/^[0-9]{10}$/, 'Please enter a valid 10-digit mobile number'] },
    address: {
        street: String,
        city: String,
        state: String,
    ...
    loginId: { type: String, required: [true, 'Login ID is required'], unique: true, trim: true, minlength: [4, 'Login ID must be at least 4 characters'] },
