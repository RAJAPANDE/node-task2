...
return `
<tr>
<td>${user.firstName} <span class="math-inline">\{user\.lastName\}</td\>
<td\></span>{user.email}</td>
<td>${new Date(user.lastActive).toLocaleString()}</td>
<td><span class="status-badge <span class="math-inline">\{user\.status\}"\></span>{user.status}</span></td>
<td>
...
<span>${user.firstName} <span class="math-inline">\{user\.lastName\}</span\>
</div\>
<div class\="info\-item"\>
<label\>Email\:</label\>
...
<div class="info-item">
<label>Mobile:</label>
<span><span class="math-inline">\{user\.mobileNo\}</span\>
</div\>
<div class\="info\-item"\>
<label\>Login ID\:</label\>
<span\></span>{user.loginId}</span>
</div>
</div>
</div>
...
<div class="info-item">
<label>Street:</label>
<span><span class="math-inline">\{user\.address?\.street \|\| 'N/A'\}</span\>
</div\>
<div class\="info\-item"\>
<label\>City\:</label\>
<span\></span>{user.address?.city || 'N/A'}</span>
</div>
<div class="info-item">
<label>State:</label<span>${user.address?.state || 'N/A'}</span>
</div>
<div class="info-item">
<label>Country:</label>
